    ...
    <main className="min-h-screen bg-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              <Link href="/portfolio/websites">
                <div className="group relative h-full min-h-[400px] sm:min-h-[500px] bg-[rgba(95,169,159,0.05)] border-2 border-[rgba(95,169,159,0.2)] rounded-[24px] p-8 sm:p-10 hover:border-[#f2a921] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(242,169,33,0.3)] overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    ...
                    <div className="mb-6">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-[rgba(95,169,159,0.15)] border border-[#5FA99F] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <svg className="w-8 h-8 sm:w-10 sm:h-10 text-[#f2a921]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="pb-[80px] sm:pb-[100px] px-4 sm:px-6">
        ...
        >
          ...
          <Link
            href="/contact"
            className="inline-block bg-[#f2a921] text-white font-heading px-8 py-4 text-[1.125rem] rounded-full font-semibold hover:bg-[#d69419] hover:shadow-[0_0_30px_rgba(242,169,33,0.4)] transition-all duration-300 hover:scale-105"
          >
            Start Your Project
          </Link>
        </motion.div>
