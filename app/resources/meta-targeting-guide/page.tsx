...
export default function MetaTargetingGuidePage() {
  return (
    <main className="min-h-screen bg-[#0A1628] pt-[100px] pb-[80px]">
      <div className="max-w-[900px] mx-auto px-6">
        ...
        >
          ...
          <p className="text-[#D4A574] text-[1.2rem] max-w-[600px] mx-auto">
        ...
        >
          <div className="bg-gradient-to-br from-[#0B1D2E] to-[#162E42] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-10 sm:p-12">
            ...
            <div className="space-y-6 text-[#F8F6F3] text-[1.05rem] leading-relaxed">
              <p>
              ...
              <p className="text-[#D4A574] text-[1.15rem] font-semibold">
        ...
        >
          <div className="bg-gradient-to-br from-[#0B1D2E] to-[#162E42] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-10 sm:p-12">
            ...
            <p className="text-[#F8F6F3] text-[1.05rem] mb-10 leading-relaxed">
            ...
            <div className="mb-10">
              <div className="bg-gradient-to-r from-[#2E5266] to-[#1A3345] border-2 border-[#4A7C9D] rounded-2xl p-8">
                ...
                <p className="text-[#F8F6F3] text-[1.15rem] mb-6 leading-relaxed">
                  These are strangers. They've never heard of your business.
                </p>

                <div className="grid sm:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h4 className="text-[#5FA99F] font-bold text-[1.3rem] mb-3">Who They Are:</h4>
                    <ul className="space-y-3 text-[#F8F6F3] text-[1.05rem]">
                  ...
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-[1.3rem] mb-3">What to Expect:</h4>
                    <ul className="space-y-3 text-[#F8F6F3] text-[1.05rem]">
                ...
                <div className="mt-6 bg-[rgba(212,165,116,0.1)] border border-[#D4A574] rounded-xl p-5">
                  <p className="text-[#F8F6F3] text-[1.05rem]">
          ...
          <div className="bg-gradient-to-br from-[#0B1D2E] to-[#162E42] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-10 sm:p-12">
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                <p className="text-[#F8F6F3] text-[1.05rem] mb-4 leading-relaxed">
                  Start with a tight radius around your business location.
                </p>
                <ul className="space-y-3 text-[#F8F6F3] text-[1rem]">
              ...
              <div className="bg-[rgba(255,107,107,0.1)] border-l-4 border-red-500 p-4 rounded-lg">
                <p className="text-[#F8F6F3] text-[0.95rem]">
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Age Range</h4>
                    <p className="text-[#F8F6F3] text-[0.95rem] mb-3">Don't target 18-65. That's everyone.</p>
                    <p className="text-[#5FA99F] text-[0.9rem]">Example: "Our customers are mostly 30-50"</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Gender</h4>
                    <p className="text-[#F8F6F3] text-[0.95rem] mb-3">If your product skews one way, target that.</p>
                    <p className="text-[#5FA99F] text-[0.9rem]">Example: Med spa? 80% women.</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Income Level</h4>
                    <p className="text-[#F8F6F3] text-[0.95rem] mb-3">Can they afford your service?</p>
                    <p className="text-[#5FA99F] text-[0.9rem]">Example: Top 25% of zip code</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Life Stage</h4>
                    <p className="text-[#F8F6F3] text-[0.95rem] mb-3">Parents? Married? Empty nesters?</p>
                    <p className="text-[#5FA99F] text-[0.9rem]">Example: Parents with kids 0-5</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                <p className="text-[#F8F6F3] text-[1.05rem] mb-6 leading-relaxed">
                ...
                <div className="space-y-6">
                  <div className="bg-[rgba(11,29,46,0.5)] rounded-lg p-5">
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Example: Dental Practice</h4>
                    <div className="flex flex-wrap gap-2">
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Cosmetic dentistry</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Dental health</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Invisalign</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Teeth whitening</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Health & wellness</span>
                    </div>
                  </div>

                  <div className="bg-[rgba(11,29,46,0.5)] rounded-lg p-5">
                    <h4 className="text-[#D4A574] font-bold text-[1.1rem] mb-3">Example: Fitness Studio</h4>
                    <div className="flex flex-wrap gap-2">
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Yoga</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Pilates</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">CrossFit</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Health food</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Meditation</span>
                      <span className="bg-[rgba(212,165,116,0.2)] border border-[#D4A574] text-[#D4A574] px-3 py-1 rounded-full text-[0.85rem]">Wellness</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-3 py-1 rounded-lg font-bold text-[0.9rem] mr-4 mt-1">WEEK 1</div>
                    <p className="text-[#F8F6F3] text-[1rem] flex-1">Run your ad. Don't touch anything. Let Meta learn.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-3 py-1 rounded-lg font-bold text-[0.9rem] mr-4 mt-1">WEEK 2</div>
                    <p className="text-[#F8F6F3] text-[1rem] flex-1">Check your results. Is cost per click under $2? Are people converting? If not, narrow your audience.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-3 py-1 rounded-lg font-bold text-[0.9rem] mr-4 mt-1">WEEK 3</div>
                    <p className="text-[#F8F6F3] text-[1rem] flex-1">Try a different age range or interest. See if it improves.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#D4A574] text-[#0B1D2E] px-3 py-1 rounded-lg font-bold text-[0.9rem] mr-4 mt-1">MONTH 2</div>
                    <p className="text-[#F8F6F3] text-[1rem] flex-1">You now know what works. Double down on that audience.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 mb-6">
            <h3 className="text-[#0B1D2E] font-bold text-[1.2rem] mb-4">Starting Template for Local Businesses:</h3>
            <div className="space-y-3 text-[#0B1D2E] text-[1rem]">
          ...
          <div className="text-center">
            <p className="text-[#0B1D2E] text-[1.1rem] font-semibold">
        ...
        >
          <p className="text-[#D4A574] text-[0.95rem]">
            This guide is free to use and share. Good luck with your Meta ads.
          </p>
        </motion.div>
