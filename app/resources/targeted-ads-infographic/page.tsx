...
export default function TargetedAdsInfographic() {
  return (
    <main className="min-h-screen pt-[120px] pb-[80px] px-6 bg-[#000000] relative">
      ...
      <div className="max-w-[1000px] mx-auto">
        ...
        <Link
          href="/resources"
          className="inline-flex items-center gap-2 text-[#85C7B3] hover:text-[#F2A922] transition-colors duration-300 mb-8 font-heading text-[0.95rem]"
        >
        ...
        <div className="text-center mb-12">
          <motion.h1
            className="font-heading text-[2rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[3.5rem] font-bold text-[#EEF4D9] mb-6 leading-[1.1] break-words"
          ...
          <motion.p
            className="text-[#85C7B3] text-[1rem] sm:text-[1.1rem] md:text-[1.2rem] font-heading leading-[1.6] max-w-[700px] mx-auto mb-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="font-heading text-[1.5rem] sm:text-[1.75rem] md:text-[2rem] font-semibold text-[#EEF4D9] mb-4">
              What's Inside
            </h2>
            <div className="text-left max-w-[600px] mx-auto space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[#85C7B3] text-[0.95rem] sm:text-[1rem] md:text-[1.05rem] font-heading leading-[1.6]">
          ...
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center gap-3 bg-gradient-to-br from-[#F2A922] to-[#EEF4D9] text-[#012E40] px-8 py-4 md:px-10 md:py-5 rounded-xl text-[1rem] sm:text-[1.1rem] md:text-[1.2rem] font-bold font-heading border-2 border-transparent transition-all duration-300 shadow-[0_8px_25px_rgba(242,169,34,0.3)] hover:transform hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(242,169,34,0.5)] focus:outline focus:outline-[3px] focus:outline-[rgba(242,169,34,0.5)] focus:outline-offset-2 no-underline"
            >
            ...
            <p className="text-[#85C7B3] text-[0.85rem] sm:text-[0.9rem] font-heading mt-4">
        ...
        >
          <p className="text-[#85C7B3] text-[0.95rem] sm:text-[1rem] font-heading leading-[1.6] mb-6">
