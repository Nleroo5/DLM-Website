      ...
      <section className="pt-[140px] pb-[80px] px-6 bg-[#000000] relative">
        <div className="max-w-[1200px] mx-auto text-center">
          <motion.h1
            ...
            className="font-heading text-[2rem] sm:text-[2.25rem] md:text-[2.75rem] lg:text-[3rem] font-bold text-white mb-6 leading-[1.1]"
          >
          ...
          <motion.p
            ...
            className="font-body text-[1rem] sm:text-[1.0625rem] md:text-[1.125rem] lg:text-[1.25rem] text-[#5FA99F] max-w-[800px] mx-auto leading-[1.6]"
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <motion.div
                  ...
                  className="relative h-[300px] sm:h-[400px] bg-[#1A1A1A] rounded-[24px] overflow-hidden border-2 border-[#5FA99F]/30 shadow-[0_0_30px_rgba(95,169,159,0.3)] hover:border-[#5FA99F]/50 hover:shadow-[0_0_40px_rgba(95,169,159,0.4)] transition-all duration-400"
                >
                  <Image
