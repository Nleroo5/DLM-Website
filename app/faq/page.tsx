  ...
  return (
    <div className="bg-transparent text-[#EEF4D9] font-sans pt-32 pb-10 px-5 max-w-[800px] mx-auto">
      ...
      <section className="text-center mb-12 flex justify-center">
        <motion.h1
          className={`font-serif text-[3.5rem] font-normal text-[#EEF4D9] m-0 cursor-pointer relative inline-block px-12 py-8 bg-[rgba(238,244,217,0.1)] backdrop-blur-[20px] border border-[rgba(238,244,217,0.2)] rounded-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.1),inset_0_-1px_0_rgba(0,0,0,0.1)] [text-shadow:0_2px_4px_rgba(0,0,0,0.1)] transition-all duration-[400ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:scale-[1.03] hover:-translate-y-[2px] hover:[text-shadow:0_8px_16px_rgba(0,0,0,0.2)] hover:tracking-[0.02em] hover:bg-[rgba(238,244,217,0.15)] hover:border-[rgba(238,244,217,0.3)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_-1px_0_rgba(0,0,0,0.1)] active:scale-[1.02] active:translate-y-0 md:text-[2.5rem] md:px-8 md:py-6 sm:text-[2rem] sm:px-6 sm:py-5 overflow-hidden ${headingPulse ? 'animate-[headingPulse_0.6s_ease-out]' : ''}`}
