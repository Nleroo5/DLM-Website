...
export default function MetaAdsTargetAudienceGuide() {
  ...
  const faqItems = [
    {
      question: "What's the minimum audience size for Facebook ads to work effectively?",
      answer: "For most campaigns, aim for at least 50,000-100,000 people in your target audience. Audiences smaller than 10,000 limit Meta's ability to optimize and drive up costs. However, if you are targeting a very specific niche (like CEOs in Atlanta), a smaller audience of 5,000-10,000 can still work if the targeting is precise and the offer is highly relevant."
    },
    {
      question: "Should I target the same audience on both Facebook and Instagram?",
      answer: "Yes, in most cases. Meta's algorithm automatically shows your ads on whichever platform performs better for each user. By targeting both Facebook and Instagram (called Advantage+ placements), you give Meta more flexibility to optimize. Only separate them if you have platform-specific creative or your product appeals to distinctly different demographics on each platform."
    },
    {
      question: "How often should I refresh or change my target audience?",
      answer: "Don't change your audience during the first 30 days while Meta is learning. After 30 days, review performance. If your cost per lead is high or conversion rate is low, test a new audience while keeping your original running. Successful audiences can run for 3-6 months before needing adjustment. Only change when performance drops, not on a fixed schedule."
    },
    {
      question: "Can I target my competitors' customers on Facebook?",
      answer: "Not directly. Meta removed the ability to target specific company pages or competitor names due to privacy concerns. However, you can target people interested in your industry category or related topics. For example, a yoga studio can't target people who like a competitor's page, but can target people interested in yoga, wellness, meditation, and fitness."
    },
    {
      question: "What's the difference between 'People who live in this location' vs 'People recently in this location'?",
      answer: "People who live in this location targets residents based on their home address and regular activity patterns. People recently in this location targets anyone currently in the area, including tourists and visitors. For local service businesses, always choose people who live in the location. Only use recently in location if you are a hotel, tourist attraction, or event targeting travelers."
    },
    {
      question: "How narrow is too narrow when targeting interests?",
      answer: "If your audience size drops below 50,000 and your cost per click exceeds $5, your targeting is too narrow. Avoid stacking too many AND conditions (must like yoga AND meditation AND wellness AND be vegan). Instead, use 5-10 related interests and let Meta find people who match at least some of them. Broader targeting within your niche often outperforms hyper-specific combinations."
    },
    {
      question: "Should I exclude any audiences when targeting?",
      answer: "Yes, exclude three groups: (1) existing customers if you are acquiring new ones, (2) people who already converted in the last 30 days to avoid ad fatigue, and (3) your own employees and page admins to prevent skewed data. Avoid over-excluding based on interests as it limits Meta's optimization. Focus exclusions on behavior, not demographics."
    }
  ];
      ...
      <article className="bg-[#000000]">
          ...
          <div className="bg-gradient-to-br from-[#000000] to-[#1A1A1A] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-6 sm:p-10 lg:p-12">
            ...
            <div className="space-y-6 text-[#F8F6F3] text-body leading-relaxed">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] border-l-4 border-[#5FA99F] p-6 rounded-lg my-8">
                ...
                <p className="text-[#5FA99F] font-bold text-lg">
        ...
        >
          <div className="bg-gradient-to-br from-[#000000] to-[#1A1A1A] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-6 sm:p-10 lg:p-12">
            ...
            <p className="text-[#F8F6F3] text-body mb-10 leading-relaxed">
            ...
            <div className="mb-10">
              <div className="bg-gradient-to-r from-[#2E5266] to-[#1A3345] border-2 border-[#4A7C9D] rounded-2xl p-8">
                ...
                <p className="text-[#F8F6F3] font-sans text-body-lg mb-6 leading-[1.6]">
                  These are strangers. They've never heard of your business.
                </p>

                <div className="grid sm:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h4 className="text-[#5FA99F] font-bold text-h3 mb-3">Who They Are:</h4>
                    <ul className="space-y-3 text-[#F8F6F3] font-sans text-body">
                  ...
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">What to Expect:</h4>
                    <ul className="space-y-3 text-[#F8F6F3] font-sans text-body">
                ...
                <div className="mt-6 bg-[rgba(212,165,116,0.1)] border border-[#D4A574] rounded-xl p-5">
                  <p className="text-[#F8F6F3] font-sans text-body">
            ...
            <div className="mb-10">
              <div className="bg-gradient-to-r from-[#4A5D3F] to-[#2C3826] border-2 border-[#6B8A5E] rounded-2xl p-8">
                ...
                <p className="text-[#F8F6F3] text-body-lg mb-6 leading-relaxed">
                ...
                <div className="grid sm:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h4 className="text-[#5FA99F] font-bold text-h3 mb-3">Who They Are:</h4>
                    <ul className="space-y-3 text-[#F8F6F3] text-body">
                ...
                <div className="mt-6 bg-[rgba(212,165,116,0.1)] border border-[#D4A574] rounded-xl p-5">
                  <p className="text-[#F8F6F3] text-body">
          ...
          <div className="bg-gradient-to-br from-[#000000] to-[#1A1A1A] border border-[rgba(95,169,159,0.2)] rounded-[32px] p-6 sm:p-10 lg:p-12">
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                <p className="text-[#F8F6F3] text-body mb-4 leading-relaxed">
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Age Range</h4>
                    <p className="text-[#F8F6F3] text-body mb-3">Don't target 18-65. That's everyone.</p>
                    <p className="text-[#5FA99F] text-body">Example: "Our customers are mostly 30-50"</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Gender</h4>
                    <p className="text-[#F8F6F3] text-body mb-3">If your product skews one way, target that.</p>
                    <p className="text-[#5FA99F] text-body">Example: Med spa? 80% women.</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Income Level</h4>
                    <p className="text-[#F8F6F3] text-body mb-3">Can they afford your service?</p>
                    <p className="text-[#5FA99F] text-body">Example: Top 25% of zip code</p>
                  </div>
                  <div>
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Life Stage</h4>
                    <p className="text-[#F8F6F3] text-body mb-3">Parents? Married? Empty nesters?</p>
                    <p className="text-[#5FA99F] text-body">Example: Parents with kids 0-5</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-10">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6 mb-4">
                <p className="text-[#F8F6F3] text-body mb-6 leading-relaxed">
                ...
                <div className="space-y-6">
                  <div className="bg-[rgba(0,0,0,0.5)] rounded-lg p-5">
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Example: Dental Practice</h4>
                  ...
                  <div className="bg-[rgba(0,0,0,0.5)] rounded-lg p-5">
                    <h4 className="text-[#D4A574] font-bold text-h3 mb-3">Example: Fitness Studio</h4>
                    <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-[rgba(95,169,159,0.1)] rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-2 py-1 sm:px-3 sm:py-1 rounded-lg font-bold text-[0.85rem] sm:text-[0.95rem] lg:text-lg mr-3 sm:mr-4 mt-1 flex-shrink-0">WEEK 1</div>
                    <p className="text-[#F8F6F3] text-body flex-1">Run your ad. Don't touch anything. Let Meta learn.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-2 py-1 sm:px-3 sm:py-1 rounded-lg font-bold text-[0.85rem] sm:text-[0.95rem] lg:text-lg mr-3 sm:mr-4 mt-1 flex-shrink-0">WEEK 2</div>
                    <p className="text-[#F8F6F3] text-body flex-1">Check your results. Is cost per click under $2? Are people converting? If not, narrow your audience.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#5FA99F] text-white px-2 py-1 sm:px-3 sm:py-1 rounded-lg font-bold text-[0.85rem] sm:text-[0.95rem] lg:text-lg mr-3 sm:mr-4 mt-1 flex-shrink-0">WEEK 3</div>
                    <p className="text-[#F8F6F3] text-body flex-1">Try a different age range or interest. See if it improves.</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-[#D4A574] text-[#000000] px-2 py-1 sm:px-3 sm:py-1 rounded-lg font-bold text-[0.85rem] sm:text-[0.95rem] lg:text-lg mr-3 sm:mr-4 mt-1 flex-shrink-0">MONTH 2</div>
                    <p className="text-[#F8F6F3] text-body flex-1">You now know what works. Double down on that audience.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="bg-[rgba(95,169,159,0.1)] backdrop-blur-sm rounded-2xl p-6 mb-6 border border-[rgba(95,169,159,0.3)]">
              <h3 className="text-[#5FA99F] font-bold text-h3 mb-4">Starting Template for Local Businesses:</h3>
              <div className="space-y-3 text-white text-body">
            ...
            <div className="text-center">
              <p className="text-gray-300 text-body-lg font-semibold">
