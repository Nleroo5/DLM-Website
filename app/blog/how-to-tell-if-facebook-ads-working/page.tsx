    ...
    <main className="min-h-screen bg-[#000000]">
      ...
      <section className="pt-[140px] pb-[60px] px-6 bg-gradient-to-br from-[#0A0A0A] to-[#000000] relative">
        ...
        <div className="max-w-[900px] mx-auto">
          <div className="mb-6">
            <Link href="/blog" className="text-[#5FA99F] hover:text-[#85C7B3] font-body text-sm transition-colors">
              ← Back to Blog
            </Link>
          </div>

          <h1 className="font-heading text-[2rem] sm:text-[2.5rem] md:text-[3rem] font-bold text-white mb-6 leading-[1.1]">
      ...
      <article className="pb-[80px] px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="mb-16">
            ...
            <ul className="list-disc list-inside text-gray-300 font-body text-lg leading-relaxed mb-6 space-y-2">
          ...
          <div className="mb-16 bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-8 border-2 border-[#5FA99F]/30">
            <h2 className="font-heading text-[1.75rem] sm:text-[2rem] md:text-[2.25rem] font-bold text-white mb-4">
              4. Cost Per Lead (CPL) - Are You Getting Customers?
            </h2>
            <p className="text-[#5FA99F] font-body text-lg font-semibold mb-6">
          ...
          <div className="mb-16 bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-8">
            ...
            <div className="bg-[#0A0A0A] rounded-lg p-6 mb-6 font-mono text-sm">
          ...
          <div className="mb-12">
            ...
            <ol className="list-decimal list-inside text-gray-300 font-body text-lg leading-relaxed mb-8 space-y-3">
          ...
          <div className="bg-gradient-to-br from-[#5FA99F]/10 to-[#85C7B3]/10 rounded-2xl p-8 border-2 border-[#5FA99F]/30 text-center">
            ...
            <p className="text-gray-300 font-body text-lg leading-relaxed mb-6 max-w-[700px] mx-auto">
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Link href="/resources/meta-targeting-guide" className="bg-[#1A1A1A] rounded-lg p-6 hover:bg-[#222222] transition-colors border border-[#5FA99F]/20 hover:border-[#5FA99F]/40">
                <h4 className="font-heading text-lg font-semibold text-white mb-2">Meta Ad Targeting Guide</h4>
