    ...
    <main className="blog-page min-h-screen bg-[#000000] relative">
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-12 lg:px-16">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-300 text-body-lg leading-relaxed font-light">
      ...
      <div className="bg-[#000000] border-b border-[#5FA99F]/20">
        <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-20 py-6">
          <div className="flex flex-wrap items-center gap-6 text-gray-400 font-body text-body-sm">
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-16 py-12 sm:py-10 sm:py-12 lg:py-16 lg:py-20">
          ...
          >
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                {/* Left Column - Text */}
                <div>
                  <p className="text-white text-body leading-relaxed mb-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-baseline justify-between mb-2">
                        <span className="text-gray-400 font-body text-body-sm">Homepage</span>
                      ...
                      <p className="text-gray-400 font-body text-body-sm mt-2">Conversion rate</p>
                    </div>
                    <div>
                      <div className="flex items-baseline justify-between mb-2">
                        <span className="text-gray-400 font-body text-body-sm">Dedicated Landing Page</span>
            ...
            <div className="max-w-6xl mx-auto px-6 sm:px-12 lg:px-16">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="flex flex-col items-start gap-3 bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-colors">
                  ...
                  <span className="text-white text-body leading-normal">Why dedicated landing pages outperform homepages</span>
                </div>
                <div className="flex flex-col items-start gap-3 bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-colors">
                  <div className="w-12 h-12 rounded-full bg-[#5FA99F] flex items-center justify-center flex-shrink-0">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white text-body leading-normal">The 5 essential elements that make landing pages convert</span>
                </div>
                <div className="flex flex-col items-start gap-3 bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-colors">
                  <div className="w-12 h-12 rounded-full bg-[#5FA99F] flex items-center justify-center flex-shrink-0">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white text-body leading-normal">Real numbers showing the cost of getting it wrong</span>
                </div>
                <div className="flex flex-col items-start gap-3 bg-white/5 p-6 rounded-xl hover:bg-white/10 transition-colors">
                  <div className="w-12 h-12 rounded-full bg-[#5FA99F] flex items-center justify-center flex-shrink-0">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white text-body leading-normal">How to set up tracking that turns clicks into customers</span>
                </div>
              </div>
            </div>
          </motion.section>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-2xl border-2 border-red-500 p-6 my-8 shadow-md">
                ...
                <div className="grid md:grid-cols-2 gap-6 items-center mb-4">
                  ...
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6">
                    <p className="text-white text-body font-semibold mb-2">The Ad Says:</p>
                  ...
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6">
                    <p className="text-white text-body font-semibold mb-3">They Click and Land On:</p>
              ...
              <div className="bg-gradient-to-r from-[#5FA99F]/20 to-[#85C7B3]/20 rounded-xl p-6 my-8">
                <p className="text-white text-body leading-relaxed font-semibold mb-0">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-2xl border-l-4 border-[#5FA99F] p-6 shadow-md hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-400 font-body text-body-sm italic">
              ...
              <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-2xl border-l-4 border-[#5FA99F] p-6 shadow-md hover:shadow-xl transition-shadow">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] border-2 border-red-300 rounded-xl p-6">
                    <p className="font-bold text-red-600 text-body mb-3">Don't Include:</p>
                    <ul className="space-y-2 text-white text-lg">
                  ...
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] border-2 border-[#7DC4BC] rounded-xl p-6">
                    <p className="font-bold text-[#5FA99F] text-body mb-3">Do Include:</p>
                    <ul className="space-y-2 text-white text-lg">
                      <li>• One headline</li>
                      <li>• One offer</li>
                ...
                <p className="text-gray-400 font-body text-body-sm italic mt-6">
              ...
              <div className="bg-[#1A1A1A]/40 backdrop-blur-xl rounded-2xl border-2 border-red-500 p-6 my-8 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6 border-l-4 border-red-600">
                    <p className="font-bold text-red-600 text-body mb-2">1. Information Overload</p>
                    <p className="text-white text-body leading-relaxed">Trying to explain your entire business on one page. Keep it focused on the one offer.</p>
                  </div>
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6 border-l-4 border-red-600">
                    <p className="font-bold text-red-600 text-body mb-2">2. Too Many Form Fields</p>
                    <p className="text-white text-body leading-relaxed">Asking for 10 pieces of information when you only need 3. Every field is a conversion killer.</p>
                    <p className="text-white/70 text-base italic mt-2">Source: HubSpot Form Conversion Research</p>
                  </div>
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6 border-l-4 border-red-600">
                    <p className="font-bold text-red-600 text-body mb-2">3. Slow Load Times</p>
                    <p className="text-white text-body leading-relaxed">If your page takes 5+ seconds to load on mobile, 40% of visitors leave before seeing anything.</p>
                    <p className="text-white/70 text-base italic mt-2">Source: Google Mobile Speed Study</p>
                  </div>
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6 border-l-4 border-red-600">
                    <p className="font-bold text-red-600 text-body mb-2">4. Generic Stock Photos</p>
                    <p className="text-white text-body leading-relaxed">Using the same photos everyone else uses. Real photos of your business, team, or results perform better.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-2xl border-l-4 border-[#5FA99F] p-6 shadow-md">
                  ...
                  <div className="bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-xl p-6">
                    ...
                    <p className="text-[#5FA99F] text-body-sm font-mono bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded p-3 break-all">
              ...
              <div className="relative bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[#5FA99F] rounded-2xl p-6 mt-12 text-center shadow-[0_8px_32px_rgba(0,0,0,0.4)] overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-br from-[#5FA99F]/10 via-transparent to-[#85C7B3]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative z-10">
                  <p className="text-white text-body font-semibold mb-2">
                    Don't worry if this sounds technical.
                  </p>
                  <p className="text-[#5FA99F] text-body font-bold">
                    This is exactly where we come in.
                  </p>
                </div>
              </div>

              <p className="text-center text-gray-400 font-body text-body-sm italic mt-6">
          ...
          >
            <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] rounded-3xl p-12 shadow-2xl">
              ...
              <p className="text-white text-body leading-relaxed mb-4 text-center max-w-3xl mx-auto">
              ...
              <p className="text-white text-body font-semibold text-center mb-4">
              ...
              <div className="relative bg-[#1A1A1A]/40 backdrop-blur-xl border-2 border-[rgba(95,169,159,0.3)] rounded-[32px] p-8 sm:p-10 text-center shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:border-[#5FA99F]/60 hover:shadow-[0_0_40px_rgba(95,169,159,0.3)] transition-all duration-500 overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <Link
                    href="/contact"
                    className="inline-block bg-[#5FA99F] hover:bg-[#85C7B3] text-white px-8 py-4 rounded-xl font-heading font-semibold text-[1rem] sm:text-lg transition-all duration-300 shadow-[0_4px_20px_rgba(95,169,159,0.4)] hover:shadow-[0_6px_30px_rgba(95,169,159,0.6)] mb-4"
                  >
