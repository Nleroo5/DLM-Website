      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            >
              <span className="text-[#5FA99F] font-heading font-semibold text-sm tracking-[0.15em] uppercase">Meta Ads Strategy</span>
            </motion.div>
      ...
      <article className="bg-[#000000]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 py-10 sm:py-12 lg:py-16">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <p className="text-[#5FA99F] text-[1.3rem] font-semibold leading-[1.6] mb-8">
            ...
            <div className="bg-gradient-to-br from-[#1A1A1A]/40 to-[#1A1A1A]/40 backdrop-blur-xl border border-[rgba(95,169,159,0.3)] rounded-[16px] p-6 my-10">
              <h2 className="text-[#5FA99F] font-heading text-[1.3rem] font-normal mb-3">
                What You'll Learn
              </h2>
            ...
            <h3 className="text-[#5FA99F] font-heading text-[1.4rem] font-semibold mt-8 mb-4">
            ...
            <h3 className="text-[#5FA99F] font-heading text-[1.4rem] font-semibold mt-10 mb-4">
            ...
            <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] rounded-3xl p-6 my-8 shadow-2xl">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gradient-to-br from-red-800 to-red-900 rounded-2xl p-6 text-white">
                  <h4 className="text-red-300 font-bold text-[1.3rem] mb-4">Boosted Post (Engagement objective)</h4>
                  <div className="space-y-3 text-[1.05rem]">
                    ...
                    <div className="border-t-2 border-red-300 pt-4 mt-6">
                      ...
                      <p className="text-[1.1rem] font-semibold">Cost per lead: $40</p>
                    </div>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-[#4A8A82] to-[#3A6E68] rounded-2xl p-6 text-white">
                  <h4 className="text-[#9DD4CD] font-bold text-[1.3rem] mb-4">Targeted Ad (Conversions objective)</h4>
                  <div className="space-y-3 text-[1.05rem]">
                    ...
                    <div className="border-t-2 border-[#9DD4CD] pt-4 mt-6">
                      ...
                      <p className="text-[1.1rem] font-semibold">Cost per lead: $21</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#5FA99F]/20 to-[#85C7B3]/20 rounded-xl p-6 text-center">
                <p className="text-white text-[1.1rem] font-bold mb-2">
            ...
            <div className="bg-gradient-to-r from-[#5FA99F]/20 to-[#85C7B3]/20 rounded-xl p-6 my-8">
              <p className="text-white text-[1.1rem] leading-[1.7] font-semibold mb-0">
            ...
            >
              ...
              <p className="text-gray-300 text-[1.05rem] mb-6 max-w-[550px] mx-auto">
