  ...
  return (
    <section className="bg-[#000000] text-[#5FA99F] py-20 px-6 font-body md:py-16 md:px-5">
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        >
          <h2 className="font-heading text-[1.75rem] sm:text-[2.25rem] lg:text-[2.75rem] mb-3 sm:mb-5 lg:mb-6 text-white font-semibold leading-[1.2] tracking-tight">
            What We Deliver
          </h2>
          <p className="text-[#5FA99F] text-[0.95rem] sm:text-[1.125rem] lg:text-[1.25rem] mb-6 sm:mb-10 lg:mb-12 font-body font-normal leading-[1.6] max-w-[700px] mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.1 }}
          transition={{ duration: 0.8, ease: [0.25, 0.1, 0.25, 1] }}
          className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-[1100px] mx-auto"
        >
