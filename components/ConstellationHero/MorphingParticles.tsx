          ...
          >
            ...
            >
              <Image
                ...
                width={80}
                height={80}
                className="drop-shadow-[0_0_10px_rgba(228,64,95,0.5)] w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 md:w-20 md:h-20"
                style={{
            ...
            >
              <Image
                ...
                width={80}
                height={80}
                className="drop-shadow-[0_0_10px_rgba(24,119,242,0.5)] w-12 h-12 xs:w-14 xs:h-14 sm:w-16 sm:h-16 md:w-20 md:h-20"
                style={{
