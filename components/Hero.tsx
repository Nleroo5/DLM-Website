  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden pt-[120px] pb-[180px] px-6">
      ...
      >
        {/* Main Headline */}
        <motion.h1
          className="font-serif text-[4.5rem] font-semibold leading-[1.1] text-[#F8F6F3] mb-8 md:text-[3rem] sm:text-[2.25rem]"
          variants={fadeInUp}
          initial="hidden"
          animate="visible"
        ...
        {/* Subheadline */}
        <motion.p
          className="font-sans text-[1.625rem] font-normal text-[#5FA99F] mb-12 leading-[1.6] max-w-[900px] mx-auto md:text-[1.25rem] md:mb-8"
          variants={fadeInUp}
          initial="hidden"
          animate="visible"
