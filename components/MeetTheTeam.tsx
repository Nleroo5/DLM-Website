  ...
  const teamMembers = [
    {
      ...
      image: "/images/nicolas-leroo-atlanta-digital-marketing-agency-founder.webp"
    },
    {
      name: "Tommy Duda",
      ...
      image: "/images/tommy-atlanta-marketing-strategist-team-member.webp"
    },
    {
      ...
      image: "/images/brenna-atlanta-marketing-consultant-team-member.webp"
    }
  ];

  return (
    <section
      className="relative min-h-screen pt-[12px] pb-[40px] md:py-[60px] px-6 overflow-hidden"
      style={{ zIndex: 7 }}
    >
