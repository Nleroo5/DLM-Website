  ...
  return (
    <section className="bg-transparent text-[#5FA99F] py-[100px] px-6 font-sans my-0 md:py-[80px] md:px-5">
      <div className="max-w-[1200px] mx-auto text-center">
        ...
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-[1200px] mx-auto md:gap-6"
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="mb-6 text-center">
                <p className="text-[1.5rem] font-semibold font-serif lg:text-[1.375rem]" style={{ color: testimonial.nameColor }}>
                  {testimonial.name}, {testimonial.title}
                </p>
              </div>

              {/* Quote */}
              <blockquote className="text-[#F8F6F3] text-[1.25rem] lg:text-[1.125rem] font-normal leading-[1.8] mb-8 opacity-90 flex-grow text-center font-[family-name:var(--font-inter)]">
                {testimonial.quote}
              </blockquote>

              {/* Company Info with Logo - Centered */}
              <div className="mt-auto pt-6 border-t border-[rgba(95,169,159,0.15)] flex flex-col items-center gap-3">
                <p className="text-[1.125rem] font-medium text-center font-[family-name:var(--font-inter)]" style={{ color: testimonial.companyColor }}>
                  {testimonial.company}
                </p>
