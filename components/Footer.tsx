  ...
  return (
    <footer className="relative bg-[rgba(10,25,47,0.95)] border-t border-[rgba(133,199,179,0.2)] pt-[40px] md:pt-[60px] pb-[20px] md:pb-[30px] mt-[60px] md:mt-[100px]">
      <div className="max-w-[1400px] mx-auto px-5 lg:px-8">
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center bg-[rgba(238,244,217,0.1)] rounded-full hover:bg-[rgba(242,169,34,0.2)] hover:scale-110 transition-all duration-300"
                aria-label="Facebook"
              >
                <svg
        ...
        {/* Bottom Bar */}
        <motion.div
          className="pt-8 border-t border-[rgba(133,199,179,0.2)] flex flex-col md:flex-row justify-between items-center gap-4"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.4 }}
        >
          <p className="font-serif text-[0.9rem] text-[#85C7B3] text-center md:text-left">
            © {currentYear} Drive Lead Media. All rights reserved.
          </p>
          <p className="font-serif text-[0.85rem] text-[#85C7B3] text-center md:text-right">
            Built with{' '}
            <span className="text-[#F2A922]">Next.js</span> &{' '}
            <span className="text-[#F2A922]">Tailwind CSS</span>
          </p>
        </motion.div>
      </div>
    </footer>
