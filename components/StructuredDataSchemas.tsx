...
export function OrganizationSchema({ url = 'https://driveleadmedia.com' }: OrganizationSchemaProps) {
  const schema = {
    ...
    "name": "Drive Lead Media",
    "alternateName": "DLM Digital Marketing",
    "legalName": "Drive Lead Media LLC",
    "url": url,
    "logo": {
      "@type": "ImageObject",
      "url": "https://driveleadmedia.com/images/drive-lead-media-atlanta-digital-marketing-agency-logo.webp",
    ...
    "image": "https://driveleadmedia.com/images/drive-lead-media-atlanta-digital-marketing-agency-logo.webp",
    "description": "Atlanta digital marketing agency specializing in Meta (Facebook & Instagram) advertising, custom website design, video ad production, and conversion-optimized landing pages. Expert Meta advertising strategists helping small and medium-sized businesses grow through data-driven campaigns.",
    "slogan": "Meta Ads & Websites That Bring Your Best Customers to You",
    "foundingDate": "2021",
    "address": {
      "@type": "PostalAddress",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Meta Advertising Management",
            "description": "Facebook and Instagram advertising campaign setup, management, optimization, and Meta Andromeda algorithm expertise"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Custom Website Design & Development",
            "description": "Mobile-responsive website design and development with Next.js, React, and conversion-focused UX"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Video Ad Production",
            "description": "Professional video ad creation for Facebook, Instagram, and social media platforms"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "High-converting landing pages optimized for Meta ad campaigns with A/B testing and analytics"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Facebook Pixel Setup & Tracking",
            "description": "Meta Pixel installation, event configuration, and conversion tracking setup"
          }
        }
      ]
    },
    "makesOffer": [
      {
        "@type": "Offer",
        "name": "Free Meta Ads Strategy Consultation",
        "description": "Complimentary 30-minute consultation to review your current Meta advertising strategy",
        "price": "0",
        "priceCurrency": "USD"
      }
    ],
