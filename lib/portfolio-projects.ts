...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    date: 'Q4 2024',
    thumbnail: '/images/atlanta-event-rental-website-tent-equipment-services.webp',
    videoUrl: '/Videos/lantz-coaching-website-video-showcase.webm',
    liveUrl: 'https://lantzcoaching.com/',
    description: 'Professional football kicking and punting coaching website for elite athlete training.',
  ...
  },
  {
    ...
    featured: true,
    date: 'Q1 2025',
    thumbnail: '/Videos/tax-tools-deviceframes.webm',
    videoUrl: '/Videos/tax-tools-deviceframes.webm',
    liveUrl: 'https://taxtoolspro.com/',
    description: 'Professional tax preparation and financial services website with client portal and tools.',
    services: ['Web Design', 'Development', 'SEO'],
    techStack: ['Next.js', 'React', 'Tailwind CSS'],
    timeline: '6 weeks'
  },
  {
    slug: 'wilcox-tax-firm',
    title: 'Wilcox Tax Firm',
    client: 'Wilcox Tax Firm',
    industry: 'Financial Services - Tax Preparation',
    type: 'website',
    category: {
      name: 'Websites',
    ...
    featured: true,
    date: 'Q1 2025',
    thumbnail: '/Videos/wilcox-tax-deviceframes.webm',
    videoUrl: '/Videos/wilcox-tax-deviceframes.webm',
    liveUrl: 'https://wilcox-tax.com/',
    description: 'Professional tax preparation and accounting services website.',
    services: ['Web Design', 'Development', 'SEO'],
    techStack: ['Next.js', 'React', 'Tailwind CSS'],
    timeline: '6 weeks'
  },
